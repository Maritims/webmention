...
class WebmentionEndpointDiscovererIntegrationTest {
    ...
    public static Stream<Arguments> discover() {
        return Stream.of(
                ...
                Arguments.of("Discovery Test #11 - Multiple no.clueless.webmention.core.receiver.Webmention endpoints advertised: Link, <link>, <a>", "https://webmention.rocks/test/11", "https://webmention.rocks/test/11/webmention"),
                ...
                Arguments.of("Discovery Test #15 - no.clueless.webmention.core.receiver.Webmention href is an empty string", "https://webmention.rocks/test/15", "https://webmention.rocks/test/15"),
                Arguments.of("Discovery Test #16 - Multiple no.clueless.webmention.core.receiver.Webmention endpoints advertised: <a>, <link>", "https://webmention.rocks/test/16", "https://webmention.rocks/test/16/webmention"),
                Arguments.of("Discovery Test #17 - Multiple no.clueless.webmention.core.receiver.Webmention endpoints advertised: <link>, <a>", "https://webmention.rocks/test/17", "https://webmention.rocks/test/17/webmention"),
                ...
                Arguments.of("Discovery Test #21 - no.clueless.webmention.core.receiver.Webmention endpoint has query string parameters", "https://webmention.rocks/test/21", "https://webmention.rocks/test/21/webmention?query=yes"),
                Arguments.of("Discovery Test #22 - no.clueless.webmention.core.receiver.Webmention endpoint is relative to the path", "https://webmention.rocks/test/22", "https://webmention.rocks/test/22/22/webmention")
                ...
                //Arguments.of("Discovery Test #23 - no.clueless.webmention.core.receiver.Webmention targetUrl is a redirect and the endpoint is relative", "https://webmention.rocks/test/23/page", "https://webmention.rocks/test/23/webmention")
        );
    }
