...
class WebmentionEndpointDiscovererTest {
    ...
    public static Stream<Arguments> discover() {
        return Stream.of(
                ...
                Arguments.of("Discovery Test #11 - Multiple no.clueless.webmention.core.receiver.Webmention endpoints advertised: Link, <link>, <a>", mockHttpResponse(Map.of("link", List.of("</webmention-endpoint>; rel=webmention")), """
                        <!DOCTYPE html>
                        <html>
                            <head>
                ...
                Arguments.of("Discovery Test #14 - False endpoint in escaped HTML", mockHttpResponse(Map.of(), """
                        ...
                        """), "https://example.com/webmention-endpoint"),
                Arguments.of("Discovery Test #15 - no.clueless.webmention.core.receiver.Webmention href is an empty string", mockHttpResponse(Map.of(), """
                        <!DOCTYPE html>
                        <html>
                            <head>
                        ...
                        """), "https://example.com"),
                Arguments.of("Discovery Test #16 - Multiple no.clueless.webmention.core.receiver.Webmention endpoints advertised: <a>, <link>", mockHttpResponse(Map.of(), """
                        <!DOCTYPE html>
                        <html>
                            <head>
                            </head>
                        ...
                        """), "https://example.com/webmention-endpoint"),
                Arguments.of("Discovery Test #17 - Multiple no.clueless.webmention.core.receiver.Webmention endpoints advertised: <link>, <a>", mockHttpResponse(Map.of(), """
                        <!DOCTYPE html>
                        <html>
                            <head>
                            </head>
                ...
                Arguments.of("Discovery Test #20 - Link tag with no href attribute", mockHttpResponse(Map.of(), """
                        ...
                        """), "https://example.com"),
                Arguments.of("Discovery Test #21 - no.clueless.webmention.core.receiver.Webmention endpoint has query string parameters", mockHttpResponse(Map.of(), """
                        <!DOCTYPE html>
                        <html>
                            <head>
                ...
                Arguments.of("Discovery Test #22 - no.clueless.webmention.core.receiver.Webmention endpoint is relative to the path", mockHttpResponse(Map.of(), """
                        <!DOCTYPE html>
                        <html>
                            <head>
