...
For the easiest deployment, head over to [Docker Hub](https://hub.docker.com/r/maritim/webmention-service) and spin up a container using [the instructions in the repository overview](https://hub.docker.com/r/maritim/webmention-service#how-to-run-a-container-using-this-image).
