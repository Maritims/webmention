...
public class DeleteWebmentionCommand extends CommandBase {
    @NotNull
    private final WebmentionManagementApiClient webmentionManagementApiClient;
    private final int                           webmentionId;

    public DeleteWebmentionCommand(@NotNull String[] args) throws MissingRequiredParameter, InvalidParameterValueException {
        var argsMap = getArgs(args, DeleteWebmentionCommand.class);
